...
import { offerDaysLeft } from '@/kg/core/dates'
import { daysBetween, shortDate } from '@/kg/core/dates'
import type { Addressable } from '@/kg/core/address'
import { useApplications } from './use-applications'
import { useTimeline } from './use-timeline'
import { useKg } from './kg-context'
import { dateMarkOn } from '@/kg/core/timeline-view'
        ...
        ? [
            {
              ...
              // Spread rather than `itemId: interviewEvent?.id`: `src/kg`
