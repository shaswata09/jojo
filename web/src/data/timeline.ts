/**
 * Façade. This module has no content of its own — it forwards the demo timeline and the date algebra to
 * `@jojo/service/data/timeline`.
 *
 ...
 *
 * Marked for deletion. The successor spelling is `@jojo/service/data/timeline`,
 * and this file goes the day the last `@/data/timeline` import does.
 */
export * from '@jojo/service/data/timeline'
