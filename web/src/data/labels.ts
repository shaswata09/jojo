/**
 * Façade. This module has no content of its own — it forwards the demo keyword labels to
 * `@jojo/service/data/labels`.
 *
 ...
 *
 * Marked for deletion. The successor spelling is `@jojo/service/data/labels`,
 * and this file goes the day the last `@/data/labels` import does.
 */
export * from '@jojo/service/data/labels'
