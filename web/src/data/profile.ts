/**
 * Façade. This module has no content of its own — it forwards the demo profile and the blank-profile helpers to
 * `@jojo/service/data/profile`.
 *
 ...
 *
 * Marked for deletion. The successor spelling is `@jojo/service/data/profile`,
 * and this file goes the day the last `@/data/profile` import does.
 */
export * from '@jojo/service/data/profile'
