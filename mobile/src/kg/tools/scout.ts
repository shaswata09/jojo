...
import { draftFromText, draftFromUrl, roleFromTitle } from '@/kg/core/parse-posting'
 ...
 * until a model is connected the only source is the fixtures. It exists for the
 * same reason `scout.posting.update` does — `useScout().addMatch` is part of a
 * signature 36 files compile against.
 */
