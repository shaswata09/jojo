 ...
 * types and eighty-three write tools already; the catalog is ninety-three entries.
 * A model choosing from a hundred and four names picks worse than one choosing
 * from ninety-three, and this app points at whatever the user is running at home
