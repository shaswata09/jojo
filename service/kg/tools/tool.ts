 ...
 * second toast.
 *
 * The no-`TODAY` rule: no module under `kg` reads a clock, and none may
...
import type { KgErrorCode } from '../core/result'
...
export type ToolContext = {
  ...
  /** Injected. No module in `kg` reads a clock or names the fixtures' day. */
